...
module.exports = "<h1>{{title}}</h1>\n    <h2>My Heroes</h2>\n    <!-- <ul class=\"heroes\">\n      <li *ngFor=\"let hero of heroes\" class=\"hero_single\"\n        [class.selected]=\"hero === selectedHero\"\n        (click)=\"onSelect(hero)\">\n        <span class=\"badge\">{{hero.id}}</span> {{hero.name}}\n      </li>\n    </ul> -->\n    <virtual-scroll [items]=\"heroes\" (update)=\"viewPortItems = $event\" class=\"heroes\">\n    <list-item *ngFor=\"let item of viewPortItems\" [item]=\"item\" class=\"hero_single\"\n      [class.selected]=\"item === selectedHero\"\n      (click)=\"onSelect(item)\">\n    </list-item>\n</virtual-scroll>\n    <div *ngIf=\"selectedHero\">\n    <h2>\n      {{selectedHero.name | uppercase}} is my hero\n    </h2>\n    <button (click)=\"gotoDetail()\">View Details</button>\n  </div>\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angular2_virtual_scroll__ = __webpack_require__("../../../../angular2-virtual-scroll/dist/virtual-scroll.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angular2_virtual_scroll___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_angular2_virtual_scroll__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__app_list__ = __webpack_require__("../../../../../src/app/app.list.ts");
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_9__app_list__["a" /* ListItemComponent */]
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__["a" /* BrowserModule */],
            __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormsModule */],
            __WEBPACK_IMPORTED_MODULE_10__app_routing_module__["a" /* AppRoutingModule */],
            __WEBPACK_IMPORTED_MODULE_3_angular2_virtual_scroll__["VirtualScrollModule"]
        ],
